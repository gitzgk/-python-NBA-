...
import random
import numpy as np
from sklearn import linear_model     #邻回归
...
def build_detaSet(all_data):
    ...
    for index,row in all_data.iterrows():
        ...
        if row['WLoc'] == 'H':
            ...
            team2_elo += 100
        #把elo当为评价没一个队伍的第一个特征值
        team1_features = [team1_elo]
        team2_features = [team2_elo]

        #添加我们从basketball reference.com 获得的每一个队伍的统计信息
